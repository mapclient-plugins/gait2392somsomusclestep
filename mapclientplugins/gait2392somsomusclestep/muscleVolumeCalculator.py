...
def muscleVolumeCalculator(subjectHeight, subjectMass):
    ...
    b1 = np.array(
        [0.123, 0.0793, 0.0478, 0.055, 0.0248, 0.0256, 0.0259, 0.0129, 0.0137, 0.0138, 0.0107, 0.0136, 0.00349,
    ...
    b2 = np.array(
        [-25.4, -4.7, -16.9, -117, 0.383, -18.2, -21.9, 12.6, 6.2, 6.07, -9.94, -31.5, 28.3, 16.2, -1.45, 8.68,
